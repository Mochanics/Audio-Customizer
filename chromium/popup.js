...
function reset() {
    ...
    chrome.storage.local.set({"max_frequency": default_values["max_frequency"]});
    ...
    chrome.storage.local.set({"min_frequency": default_values["min_frequency"]});
    ...
    chrome.storage.local.set({"enhancer_gain": default_values["enhancer_gain"]});
    ...
    chrome.storage.local.set({"enhancer": default_values["enhancer"]});
    
    document.getElementById("mono").checked = default_values["mono"];
    chrome.storage.local.set({"mono": default_values["mono"]});
...
function max_slider() {
    ...
    if (value < Number(document.getElementById("min_slider").value)) {
        ...
        chrome.storage.local.set({"min_frequency": value});
    }
    document.getElementById("max_value").innerHTML = value.toString();
    chrome.storage.local.set({"max_frequency": value});
}
...
function enhancer_slider() {
    ...
    chrome.storage.local.set({"enhancer_gain": value});
}
...
function enhancer() {
    ...
    if (value == true) {
        chrome.storage.local.set({"enhancer": true});
...
function mono() {
    ...
    if (value == true) {
        chrome.storage.local.set({"mono": true});
    } else {
...
chrome.storage.local.get(["max_frequency"], (max_value) => {
...
chrome.storage.local.get(["min_frequency"], (min_value) => {
...
chrome.storage.local.get(["enhancer_gain"], (enhancer_gain) => {
...
chrome.storage.local.get(["enhancer"], (enhancer) => {
...
chrome.storage.local.get(["mono"], (mono) => {
